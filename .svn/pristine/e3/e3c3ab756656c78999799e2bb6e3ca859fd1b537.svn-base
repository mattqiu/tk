        ...
        <div class="tps_reg_box">
            <nav class="reg_nav" >
                <ul id="tps_reg_ui">
                    ...
                    <li class="active" tab="#mail_ul" ><a href="javascript:void(0);"><?php echo lang('tps_email_register')?></a></li>
                    <li tab="#tel_ul"><a href="javascript:void(0);"><?php echo lang('tps_mobile_register')?></a></li>
                    <?php }else{?>
                    <li class="active" tab="#mail_ul"><a href="javascript:void(0);"><?php echo lang('tps_email_register')?></a></li>
                    <?php }?>
                </ul>
            ...
            <div class="register_email_mobile">
                ...
                <div class="mail_reg" id="mail_ul" >
                    <form class="register_email" method="POST" ng-non-bindable ="" >
                        <ul>
                            <li>
                            ...
                            <li class="emailCaptcha d-n">
                                ...
                                <input type="button" class="email_send_captcha" value="<?php echo lang('tps_get_captcha');?>">
                                <p class="font email_send_captcha_on_show d-n"></p>
                                <p class="font email_send_captcha_on d-n">
                                    <?php echo lang('tps_captcha_send')?>
                                    <span class="email_send_captcha_info">109049584@qq.com</span>
                                    <span class="c-b" id="msg_ui">. <?php echo lang('tps_not_received_captcha')?>？</span>
                                </p>
                            </li>
                            <li>
                                <input id="email_pwd" name="email_pwd" type="password" class="tps_input" maxlength="18" autocomplete="off" placeholder="<?php echo lang('tps_pwd'); ?>"/>
                                <span class="msg"><img src="<?php echo base_url('img/msdropdown/icons/blank.gif'); ?>"></span>
                                <p class="font c-g"></p>
                            </li>
                            <li>
                            ...
                            <!-- 注册内容提交 按钮 -->
                            <input type="button" class="tps_reg_btn email_submit_button" value="<?php echo lang('tps_consent_register')?>">
                        ...
                        <input type="hidden" name="my_csrf_token" value="<?php  echo  $csrf_hash; ?>" />
                    </form>
                </div>
                ...
                <div class="mail_reg" id="tel_ul" style="display: none;">
                    <form class="register_mobile" method="POST"  ng-non-bindable ="">
                        <ul>
                            ...
                            <li>
                                <input id="mobile_pwd" name="mobile_pwd" type="password" class="tps_input" maxlength="18" autocomplete="off" placeholder="<?php echo lang('tps_pwd'); ?>"/>
                                <span class="msg"><img src="<?php echo base_url('img/msdropdown/icons/blank.gif'); ?>"></span>
                                <p class="font c-g"></p>
                            </li>
                            <li>
                            ...
                            <input type="button" class="tps_reg_btn mobile_submit_button" value="<?php echo lang('tps_consent_register')?>">
                            <p class="font mt-10">
                                <?php echo lang('tps_exist_account')?>？
                                <a class="c-b" href="<?php echo base_url('login')?>"><?php echo lang('go_login');?></a>
                            </p>
                        ...
                        <div class="error_msg" id="msg_telcontent_ui">
                            <p><?php echo lang('tps_possible')?><br/><?php echo lang('tps_moblie_correct')?><br/><?php echo lang('tps_moblie_garbage')?><br/><?php echo lang('tps_moblie_delay')?></p>
                        </div>
                        <input type="hidden" name="my_csrf_token" value="<?php  echo  $csrf_hash; ?>" />
                    </form>
                </div>
...
<script src="<?php echo base_url('themes/mall/js/login_register_new.js?v=3'); ?>"></script>
