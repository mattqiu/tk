						...
						<div class="xm-edit-addr">
							<div class="item clear">
								<dl>
									...
									<dd>
										<input class="input" id="consignee" type="text" />
									</dd>
								</dl>
							</div>
							<div class="item clear">
							...
							<div class="item clear">
								<dl>
									...
									<dd>
										<input class="input" id="reserve_num" type="text" />
									</dd>
								</dl>
							</div>
							<div class="item clear">
							...
							<div class="item clear">
								<dl>
									<dt><span>&nbsp;</span></dt>
									<dd>
										<input class="xxidz" id="address_detail" type="text" placeholder="<?php echo lang('checkout_addr_detail_placeholder'); ?>" />
									</dd>
								</dl>
							</div>
						...
						<div class="box-bd">
									...
									<div class="x-hl clear">
										<div class="col-md-10">
											...
											<div class="col-md-10">
												<span class="g-info">
													<span>
														<a href="<?php echo base_url(); ?>index/product?snm=<?php echo $v['goods_sn_main']; ?>">
											...
											<div class="col-md-1 center"><b><?php echo $v['price_show']; ?></b></div>
							...
							<p class="yunfei">
								<em>
									...
									<span id="order_deliver_time">
										<?php echo lang('checkout_deliver_time_period1'); ?>
									</span>
								</em>
								<?php echo lang('checkout_order_deliver_fee'); ?> --
								<span><?php echo lang('checkout_order_amount')." ".$data['amount_show']; ?></span>
							</p>
