	...
	<form id='commChangeForm'>
		<div class="block-body">
			...
			<div class="row-fluid" style="height: 50px; ">
				<label style="padding-top: 10px;" form="is_commission"><input id="is_commission" type="checkbox" value="0"><?php echo lang('admin_order_commission');?></label>
			</div>
            ...
            <div class="row-fluid"><span style="color: red"><?php echo lang('order_recovery_show');?></span></div>
		</div>
...
<script>
	$("#rollbackSub").click(function () {
		...
		$.ajax({
			type: "POST",
			url: "/admin/order_report/order_recovery",
			data: {order_id: order_id,remark: remark,status: status,is_commission: is_commission},
			dataType: "json",
