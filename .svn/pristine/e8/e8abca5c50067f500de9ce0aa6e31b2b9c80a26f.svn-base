	<main class="main-content">
		<div class="banner clear">
			<div class="bd">
				<ul>
				<?php 
				$mall_ads = $mall_ads_list[$mall_ads_title[$curLocation_id]['hot']];
					if ($mall_ads[0]) {
			...
			<div class="w1200">
				...
				<div class="s-s">
					...
					<dl class="select">
						...
						<dd>
							<ul>
								<li class="cate-sel"  data-href="<?php echo $web_host,'index/goods_hot';?>"><span><?php echo lang('label_all')?></span><i class="fa fa-angle-down fr"></i></li>
                                <?php
                                foreach($category_all as $cat) {
                                    if($cat['level'] == 0) {
                            	?>
								<li class="cate-sel"  data-href="<?php echo $web_host,'index/goods_hot?cate_id=',$cat['cate_id']?>"><span><?php echo ucwords($cat['cate_name'])?></span><i class="fa fa-angle-down fr"></i></li>
								<?php
                                    }
                                }
                            	?>
        ...
        <!--
			...
			<div class="search New-hot clear">
				<div class="hd clear"><h2 class="title"><?php echo lang('label_nav_hot')?></h2></div>
				<ul class="clear lazy">
					<?php if($goods_list) {?>
