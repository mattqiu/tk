...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/usr/share/nginx/htdocs/tps138/dev/terry/certs/PM_700000000000001_acp.pfx';

// 签名证书密码
// const SDK_SIGN_CERT_PWD = '138138';
...
const SDK_VERIFY_CERT_DIR = '/usr/share/nginx/htdocs/tps138/dev/terry/certs/';
...
//文件下载目录 
const SDK_FILE_DOWN_PATH = '/usr/share/nginx/htdocs/tps138/dev/terry/file/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/usr/share/nginx/htdocs/tps138/dev/terry/logs/';
