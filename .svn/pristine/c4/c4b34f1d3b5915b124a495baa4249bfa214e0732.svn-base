	<main class="main-content">	
		<div class="banner clear">
			<div class="bd">
				<ul>
				<?php 
				$mall_ads = $mall_ads_list[$mall_ads_title[$curLocation_id]['new']];
					if ($mall_ads[0]) {
			...
			<div class="w1200">
				...
				<div class="s-s">
					...
					<dl class="select">
						...
						<dd>
							<ul>
								<li class="cate-sel"  data-href="<?php echo $web_host,'index/goods_new';?>"><span><?php echo lang('label_all')?></span><i class="fa fa-angle-down fr"></i></li>
                                <?php
                                foreach($category_all as $cat) {
                                    if($cat['level'] == 0) {
                            	?>
								<li class="cate-sel" data-href="<?php echo $web_host,'index/goods_new?cate_id=',$cat['cate_id'];?>"><span><?php echo ucwords($cat['cate_name'])?></span><i class="fa fa-angle-down fr"></i></li>
								<?php
                                    }
                                }
                            	?>
                            ...
                            <?php }?>
								...
								<dl class="tit">
									<dd class="fl">
										...
										<p class="c-o fs-14"><?php echo $curCur_flag,number_format(format_price($goods['shop_price'],$cur_rate),2);?><span class="c-bb">
<!--										/ <s> --><?php //echo $curCur_flag,number_format(format_price($goods['market_price'],$cur_rate),2);?><!--</s>-->
										</span></p>
									</dd>
									<dt class="fr">
			...
			<div class="search New-hot clear">
				<div class="hd clear"><h2 class="title"><?php echo lang('label_nav_new')?></h2></div>
				<ul class="clear lazy">
					<?php if($goods_list) {?>
...
<!--                                        / <s> --><?php //echo $curCur_flag,number_format(format_price($item['market_price'],$cur_rate),2);?><!--</s>-->
							...
							<dt class="fr">
								...
								<s class="qizhi"><img src="<?php echo $this->config->item('country_flag_path').$item['country_flag'].'.jpg'?>" width="18" height="13" /></s>
                                <?php }?>
