					...
					<table class="table table-hover table-condensed">
						<tbody>
							...
							<tr>
								...
								<td class="text-info" colspan="3"><?php echo $data['order_detail']['order_id']; ?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="text-info" colspan="3"><?php echo $data['order_detail']['address']; ?></td>
							</tr>
							...
							<tr>
								...
								<td class="text-info"><?php echo $data['order_detail']['deliver_time']; ?></td>
								<td class="text-danger"><?php echo lang('admin_order_info_receive_time'); ?></td>
								<td class="text-info"><?php echo $data['order_detail']['receive_time']; ?></td>
							</tr>
							<tr>
								<td class="text-danger"><?php echo lang('admin_order_status'); ?></td>
								<td class="text-info"><?php echo $status_map[$data['order_detail']['status']]; ?></td>
