...
<div class="bj_zhuti">
  ...
  <div class="container clear">
    <div class="row clear">
      <div class="crumbs">
        <i class="pc-tps">&#xe632;</i> <a href="<?php echo base_url()?>"><?php echo lang('label_home')?> </a> &gt; <?php echo $nav_title?>
      </div> 
        ...
        <div class="Drive Search clear">
          ...
          <div class="cp_detail clear">
            ...
            <div class="jiage clear">
              <p class="title"><span class="pink"><?php echo $curCur_flag,number_format(format_price($item['shop_price'],$cur_rate),2);?></span>/<s><?php echo $curCur_flag,number_format(format_price($item['market_price'],$cur_rate),2);?></s></p>
