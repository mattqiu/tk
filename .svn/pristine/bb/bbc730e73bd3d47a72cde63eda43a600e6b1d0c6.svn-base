 ...
 */
?>
<div class="main-content g-world g-ouzhoubg">
    <s class="ggao ouzhou"></s>
    <div class="w1200">
...
<!--             <span class="next"><i class="pc-tps">&#xe648;</i></span> -->
        ...
        <div class="tps-line pr">
            <div class="tc pr"><s class="s4 ouzhou_icon"></s><b class="d-ib"><?php echo lang('tps_global'); ?></b></div>
            <i class="pc-tps qqg"></i>
            <ul class="tps-wrap ouzhou-wrap clear">
