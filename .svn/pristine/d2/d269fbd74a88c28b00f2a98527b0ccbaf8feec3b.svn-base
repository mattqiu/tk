		...
		<div class="box-bd">
			<dl class="clear">
				...
				<dt class="clear">
					...
					<span class="col-md-1 center"><?php echo lang('goods_attr'); ?></span>
					<span class="col-md-2 center"><?php echo lang('cart_price'); ?></span>
					<span class="col-md-2 center"><?php echo lang('cart_quantity'); ?></span>
					<span class="col-md-2 center"><?php echo lang('cart_amount_to'); ?></span>
...
<!--							--><?php //endif; ?>
					...
					<div class="col-md-2 center mt-10">
...
<!--                            <s>--><?php //echo $v['market_price']; ?><!--</s>-->
					...
					<div class="col-md-1 center mt-10">
