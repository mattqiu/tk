...
<head>
	...
	<link href="<?php echo base_url(THEME.'/css/all.css?v=4')?>" rel="stylesheet" type="text/css">
			...
			<div class="container clear">
				<div class="row">
					...
					<div class="top-right"> <span class="float-left"><?php echo lang('label_hello')?>,</span>
						...
						<?php }else{?>
						<span class="float-left"><a href="<?php echo base_url('ucenter')?>" style="color:orange;"><?php echo $userInfo['email']?$userInfo['email']:$userInfo['mobile'];?></a></span>
						<?php }?>
			...
			<div class="container clear">
				<div class="row">
					<div class="logo"><a href="<?php echo base_url();?>"><img src="<?php echo $store_id == '1380141986' ? base_url(THEME.'/img/logo_1380141986.png') : base_url(THEME.'/img/logo.png');?>"></a>
                         ...
                         <?php }else {?>
						<s class="logo_bt" style="background-image:url(<?php if($curLan == 'english' || $curLan == 'kr') echo base_url(THEME.'/img/logo_'.$curLan.'.gif'); else echo base_url(THEME.'/img/logo_'.$curLan.'.jpg')?>);<?php if($curLan == 'english'|| $curLanguage == 'kr'){?>width:182px;<?php }?>"></s>
						<?php }?>
						<?php if($store_info){?>
							<div class="slogo">
