...
<body>
<?php //var_dump($goods_info_list[0]);?>
<!--top-->
<div class="bj_zhuti">
    <div class="MyCart">
        <div class="container clear">
            <div class="dianxx clear">
                <i>
					<img src="<?php echo base_url("/img/$curLanguage/product.png")?>"/>
                </i>
                <!-- 用户升级选购-->
                <?php if(isset($data)&& $data!=null){?>
                    <div class="col-md-2 clear">
						<dl class="clear">
							<dt><s class="s2"></s></dt>
							<dd><em><?php echo $data['old_level'] ?></em>
								<?php echo $data['name'] ?>
                    ...
                    <div class="col-md-10 clear">
                        <div class="right clear">
                            ...
                            ?>
                            <p><?php echo lang_attr('choose_package_row_1_upgrade', $attr); ?></p>
                            <p><?php echo lang_attr('choose_package_row_2_upgrade', $attr); ?></p>
                            <p class="ts"><?php echo lang_attr('choose_package_row_3_upgrade', $attr); ?></p>
                        </div>
                    </div>
                <?php }?>
            </div>
                                                ...
                                                <?php foreach ($group['list'] as $goods) { ?>
                                                    ...
                                                    <li class="col-md-3">
                                                        ...
                                                        <dl class="marg_10 clear">
                                                            ...
                                                            <dd>
                                                                <a href="<?php echo base_url('index/product?snm='.$goods['info']['goods_sn_main'])?>" class="tit" target="_blank"><?php echo $goods['info']['goods_name'] ?></a>
                                    ...
                                    <div class="Drive tao_z marg_10">
                                        ...
                                        <div class="cp_detail clear">
                                            ...
                                            <div class="jiage clear">
                                                ...
                                                <div class="huangou">
                                                    <a href="javascript:;" class="Buy" goods_id="<?php echo $goods['goods_id']?>" ><i></i><?php echo lang('huangou')?></a>
...
<div class="pop-compare clear ">
    <div class="huangouqu">
        ...
        <div class="body clear">
            ...
            <div class="col-md-2">
                <div class="rig">
                    <p style="font-size: 16px;"><?php echo lang('all_choose_goods_price')?></p>
                    <p style="font-size: 16px;">$<b id="product_total_money">--</b></p>
                    <a href="javascript:confirm_choose_upgrade() ;" class="btn_Bhui" style="background: #006699"><?php echo lang('confirm_huangou')?></a>
		...
		if(country_id == '' || country_id == 'undefined'){
			...
			$.ajax({
				...
				success: function (res) {
					if (res.success) {
						location.href = 'member_upgrade?param='+res.param;
					} else {
						layer.msg(res.msg);
					}
				}
