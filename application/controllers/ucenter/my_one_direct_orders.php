...
class My_one_direct_orders extends MY_Controller {
    ...
    public function index() {
        $this->_viewData['title'] = lang('my_one_direct_orders');
        ...
        $orders = $this->M_order->getDirectOrders($filter,$page,$perPage);
        $customer_ids = array();
        ...
        $config['base_url'] = base_url('ucenter/my_one_direct_orders?start='.$start.'&end='.$end);
        $config['total_rows'] = $this->M_order->getDirectTotalRows($filter);
