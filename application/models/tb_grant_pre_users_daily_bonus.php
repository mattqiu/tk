 ...
 * Time: 17:26
 */
class tb_grant_pre_users_daily_bonus extends MY_Model
{
	protected $table = "grant_pre_users_daily_bonus";
	protected $table_name = "grant_pre_users_daily_bonus";
	...
	{
		if (empty($uid)) {
			$res = $this->db->from("grant_pre_users_daily_bonus as a")
