...
<div class="well">
	<form class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label" for="addr_country_address"><?php echo lang('country'); ?></label>
			<div class="controls">
				<input class="input-xxlarge" id="addr_country_address" type="text" value="<?php echo $data['order_detail']['country_address']; ?>" />
			</div>
		</div>
		<div class="control-group">
...
$(function() {
	...
	<?php if ($data['order_detail']['is_export_lock'] == 1 && !in_array($adminInfo['role'],array(0,3)) && $adminInfo['id']!=66 ): ?>
		...
		$('#addr_country_address').prop('disabled', true);
...
function submit_modify()
{
	...
	data.country_address = $('#addr_country_address').val();
