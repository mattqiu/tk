    ...
    $(function(){
        ...
        $('#user_id').bind('input propertychange', function () {
            ...
            check_user = setTimeout(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/admin/cash_to_sharing_point/check",
                    data: {id: uid},
                    dataType: "json",
        ...
        $('#transfer_point').click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "/admin/cash_to_sharing_point/do_transfer",
                data: {id:$('#user_id').val(),money:$('#manuallyMoney').val()},
                dataType: "json",
                success: function (res) {
                    if (res.success) {
						...
						$('#transfer_point').attr("disabled",false);
						$('#manuallyMoney,#manuallyPoint').val('');
                    }else{
        ...
        <tr style="height: 50px;" >
            ...
            <td class="content" >
				<div class="proportion_input_div">
					...
					<span><input class="proportion_input" type="text" id="manuallyMoney" value="" readonly="" autocomplete="off"></span>
					<span class="percent">=</span>
					<span><input class="proportion_input" type="text" id="manuallyPoint" value="" readonly="" autocomplete="off"></span>
					<span class="percent"><?php echo lang('point');?></span>
					<span class="percent"><?php echo lang('to');?></span>
					<span class="percent"><?php echo lang('sharing_point');?></span>
					<span id='manuallyMsg' class="msg"></span>
				</div>
            </td>
        </tr>
        <tr>
