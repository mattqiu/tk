		...
		<div class="container clear">
			<div class="row clear">
				<div class="qren">
                    ...
                    <p class="zhif"><?php echo lang('pay_amount'); ?><em><?php echo $pay_amount?></em></p>
                        ...
                        <div class="bodys clear">
                            ...
                            <?php }?>
							<label class="item-ifo margin20 pay_p" style="display: none" ><input type="password" autocomplete="off" placeholder="<?php echo lang('funds_pwd');?>"  value="" name="pay_pwd" class="pay_pwd itxt"></label>
							...
							<p class="clear" style="margin-top: 30px;"><input autocomplete="off" type="button" class="btn btn_zhifu go_pay_all" value="<?php echo lang('go_pay')?>"></p>
                        </div>
