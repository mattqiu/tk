			...
			<div class="fl">
				<ul>
                    ...
                    <li>
						...
						<!--可信网站图片LOGO安装开始-->
						<script src="http://kxlogo.knet.cn/seallogo.dll?sn=e17060744030067981js6u000000&size=0"></script>
						<!--可信网站图片LOGO安装结束-->
	...
	<script>
		window.onload = function(){
			...
			(function() {
				...
				//hm.src = "<?php //echo base_url('/themes/mall/js/baidu_statistics.js?v=5'); ?>";
