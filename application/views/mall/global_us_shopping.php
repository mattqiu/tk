 ...
 */
?>
<div class="main-content g-world g-usabg">
    <s class="ggao usa"></s>
    <div class="w1200">
...
<!--             <span class="next"><i class="pc-tps">&#xe648;</i></span> -->
        ...
        <div class="tps-line pr">
            <div class="tc pr">
                <s class="s4 usa_icon"></s>
                <b class="d-ib"><?php echo lang('tps_global'); ?></b>
            </div>
            <i class="pc-tps qqg"></i>
            <ul class="tps-wrap usa-wrap clear">
                <li class="btn-1"><a href="<?php echo base_url(),'index/global_shopping?elevent=korea'?>" target="_self"></a></li>
                <li class="btn-2"><a href="<?php echo base_url(),'index/global_shopping?elevent=gat'?>" target="_self"></a></li>
                <li class="btn-3"><a href="<?php echo base_url(),'index/global_shopping?elevent=canada'?>" target="_self"></a></li>
           <!--      <li class="btn-4"><a href="<?php echo base_url(),'index/global_shopping?elevent=japan'?>" target="_self"></a></li> -->
