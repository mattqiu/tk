  ...
  <div class="w1200">
    ...
    <div class="goods clear">
      ...
      <div class="itemInfo">
        <div class="tit clear">
            ...
            <em style="margin-left:0;"><?php echo lang('label_flag_free');?></em>
            <?php }?>
          ...
          <p class="c-o fs-13 clear"><?php echo $goods_info['goods_note'];?></p>
          <?php }?>
        </div>

        <p class="m-s"><?php echo lang('label_sku')?>:<span class="js-sku"><?php echo $goods_sn?></span>
        <?php if($goods_info['is_doba_goods']) {?>
        <span  class="ml-40"><?php echo lang('label_doba_item_id')?>:<?php echo $goods_info['doba_item_id']?></span>
        <?php }?>
         <span class="c-99 ml-40"><?php echo lang('label_place'),': ', $origin_array[strtolower($goods_info['country_flag'])];?></span>       
        </p>
        ...
        <dl>
          ...
          <?php if($addrName != ''){?>
          <p class="m-s"><?php echo lang('label_shipping_address')?>: <span><?php echo $addrName?></span></p>
          <?php }?>
        <div class="goods-cart clear">
          <span class="goods-cart-c">
            ...
            <?php }else {?>
            <a class="buy js-buynow" href="javascript:;"><?php echo lang('label_buy_new')?></a>
            <a class="cart js-incart" href="javascript:;"><?php echo lang('label_add_to_cart')?></a>   
            <?php }?>                 
            <?php }else {?>
            <span><?php echo lang('info_buy_invalid')?></span>
            <?php }?>
          </span>
          <a data-sn="<?php echo $goods_info['goods_sn_main']?>" data-id="<?php echo $goods_info['goods_id'];?>"  class="shouc js-like" href="javascript:;"><i class="fa fa-star-o"></i><?php echo sprintf(lang('label_wish_goods'),$wish_goods_count);?></a>
    ...
    <div class="mainCon clear">
      <div class="w1200 goods-menu">
        ...
        <?php if($goods_info['is_on_sale'] == 1 && $goods_info['goods_number'] > 0) {?>
        <a class="cart js-incart-1" href="javascript:;"><i class="fa fa-shopping-cart"></i><?php echo lang('label_add_to_cart')?></a>
        <?php }?>   
      </div>
          ...
          <ul>
            ...
            <li>
              <div class="img-xg">
                ...
                <a class="img" title="<?php echo $item['goods_name']?>" href="<?php echo base_url(),'index/product?snm=',$item['goods_sn_main'];?>" ><img src="<?php echo $img_host,$item['goods_img']?>"  /></a>
                <dl class="tit">
                  <dd class="fl">
                    <p><a title="<?php echo $item['goods_name']?>" href="<?php echo base_url(),'index/product?snm=',$item['goods_sn_main'];?>" ><?php echo $item['goods_name']?></a></p>
                    <p class="c-o fs-14"><?php echo $curCur_flag,number_format(format_price($item['shop_price'],$cur_rate),2);?></p>
...
<?php if ($supplier_qq) { ?>
  <style>
  .online_service{width:97px;min-height:150px;background:#ed4242;padding:13px;box-sizing: border-box;border-radius:6px;position:fixed;top:40%;right:0}
  .online_service .headImg{width:72px;height:57px;text-align:center;border-bottom:1px dashed #f38c8c;}
  .online_service .service_list{width:72px;text-align:center;margin-top:5px;}
  .online_service .service_list li{padding-top:6px;box-sizing:border-box;}
  .online_service .service_list li a{font-size:14px;color:#fff;}
  </style>
