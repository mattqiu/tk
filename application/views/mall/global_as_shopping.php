 ...
 */
?>
<div class="main-content g-world g-aozhoubg">
    <s class="ggao aozhou"></s>
    <div class="w1200">
        ...
        <div class="tps-line pr">
            <div class="tc pr"><s class="s4 aozhou_icon"></s><b class="d-ib"><?php echo lang('tps_global'); ?></b></div>
            <i class="pc-tps qqg"></i>
            <ul class="tps-wrap aozhou-wrap clear">
