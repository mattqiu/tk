		...
		<div class="header-bar">
			<div class="w1200">
				...
				<ul class="fr nav-top">
                    ...
                    <?php }?>
					<li class="fl mfr-5"><a href="<?php echo base_url('ucenter/my_collection')?>"><?php echo sprintf(lang('label_wish'),$wish_count);?></a></li>
					<li class="fl w92">
							...
							<?php 
								...
								if (!empty($mall_keyword_input)) {
									...
									foreach ($mall_keyword_input as $key => $value) {
										$priority = $value['priority'] == 'emphasize' ? 'style="color:red;"' : '';
										echo '<a class="c-66" href="'.$web_host .$sphinx_search_url.'?keywords='.$value['keyword'].'"'. $priority.'>'.$value['keyword'].'</a>';
