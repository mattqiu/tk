						...
						<?php }?>
                            ...
                            <?php }?>
                                <p class="b-q">
                                    ...
                                    <s class="free" title="<?php echo lang('label_nav_free_ship')?>"></s>
                                    <?php }?>
                                </p>                                        <i class="top"></i> <i class="right"></i> <i class="bottom"></i> <i class="left"></i>
                                <a target="_blank" class="img" title="<?php echo $goods['goods_name'];?>" href="<?php echo base_url(),'index/product?snm=',$goods['goods_sn_main'];?>"><img src="<?php echo $img_host,$goods['goods_img']?>" /></a>
                                <dl class="tit">
                                    <dd class="fl">
                                        <p><a target="_blank"  title="<?php echo $goods['goods_name'];?>" href="<?php echo base_url(),'index/product?snm=',$goods['goods_sn_main'];?>"><?php echo $goods['goods_name'];?></a></p>
				...
				<div class="cp">
					<ul>
						...
						<?php }?>
							...
							<i class="top"></i> <i class="right"></i> <i class="bottom"></i> <i class="left"></i>
							<a class="img" title="<?php echo $goods_list['goods_name'];?>" href="<?php echo base_url(),'index/product?snm=',$goods_list['goods_sn_main'];?>" target="_blank"><img data-original="<?php echo $img_host,$goods_list['goods_img']?>" src="<?php echo $web_host,'/themes/mall/img/loading250_250.gif'?>" /></a>
							<dl class="tit">
								<dd class="fl">
				...
				<ul>
					...
					<li>
                        ...
                        <?php if($item['is_direc_goods']) {?>
							...
							<i class="top"></i> <i class="right"></i> <i class="bottom"></i> <i class="left"></i>
							<a target="_blank" class="img" title="<?php echo $item['goods_name']?>" href="<?php echo base_url(),'index/product?snm=',$item['goods_sn_main'];?>" ><img  src="<?php echo $img_host,$item['goods_img']?>"  /></a>
							<dl class="tit">
								<dd class="fl">
