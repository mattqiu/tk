<!--Page contents-->
<div class="w1200">
    <div class="crumbs"><i class="pc-tps">&#xe632;</i> <a href="<?php echo base_url()?>"><?php echo lang('label_home')?> </a>  &gt;<?php if(isset($artical['parent_name'])) echo $artical['parent_name'];?>  <?php if(isset($artical['artical'])){ echo ' &gt; ',$artical['artical']['title'];}?></div>
