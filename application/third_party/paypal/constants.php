...
/* Define the PayPal URL. This is the URL that the buyer is
   ...
   */
define('PAYPAL_URL', 'https://www.paypal.com/webscr&cmd=_express-checkout&token='); //pro
//define('PAYPAL_URL', 'https://www.sandbox.paypal.com/webscr&cmd=_express-checkout&token='); //test
